...
{
	(void)pipe_n;
	if(g_struct.each_cmd[c_of_s].cmd[0] && ft_strchr(g_struct.each_cmd[c_of_s].cmd[0], '/'))
		execve(g_struct.each_cmd[c_of_s].cmd[0], g_struct.each_cmd[c_of_s].cmd, new_env(g_struct.list));
